        ...
        return (
            <React.Fragment>
                ...
                <Nav className="d-md-down-none" navbar>
                    ...
                    this.state.user.user_type != "PS" &&
                    this.state.user.user_type != "WU" ? (
                        <NavItem className="px-3">
                            <Link to="/customers" className={pathName == "/customers" ? "is-active" : ""}>
                                Customers
                            </Link>
                        </NavItem>
                    ) : (
                    ...
                    this.state.user.user_type != "WU" ? (
                        <NavItem className="px-3">
                            <NavLink href="/quotelist" className={pathName == "/quotelist" ? "is-active" : ""}>
                                Quotes
                            </NavLink>
                        </NavItem>
                    ) : (
                    ...
                    {this.state.user.user_type == "SA" ? (
                        <NavItem className="px-3">
                            <Link to="/dealers" className={pathName == "/dealers" ? "is-active" : ""}>
                                Dealers
                            </Link>
                        </NavItem>
                    ) : (
                    ...
                    {this.state.user.user_type == "SA" ? (
                        <NavItem className="px-3">
                            <Link to="/accessories" className={pathName == "/accessories" ? "is-active" : ""}>
                                Accessories
                            </Link>
                        </NavItem>
                    ) : (
                    ...
                    {this.state.user.user_type == "SA" ? (
                        <NavItem className="px-3">
                            <Link to="/designer" className={pathName == "/designer" ? "is-active" : ""}>
                                Designers
                            </Link>
                        </NavItem>
                    ) : (
                    ...
                    {this.state.user.user_type == "SA" ? (
                        <NavItem className="px-3">
                            <Link to="/component" className={pathName == "/component" ? "is-active" : ""}>
                                Components
                            </Link>
                        </NavItem>
                    ) : (
                    ...
                    {/* Category, Sub Category, Products Rouets */}

                    {this.state.user.user_type == "SA" ? (
                        <NavItem className="px-3">
                            <Link to="/categories" className={pathName == "/categories" ? "is-active" : ""}>
                                Categories
                            </Link>
                        </NavItem>
                    ) : (
                    ...
                    {this.state.user.user_type == "SA" ? (
                        <NavItem className="px-3">
                            <Link to="/codes" className={pathName == "/codes" ? "is-active" : ""}>
                                Codes
                            </Link>
                        </NavItem>
                    ) : (
                    ...
                    {this.state.user.user_type == "SA" ? (
                        <NavItem className="px-3">
                            <Link to="/pricemapping" className={pathName == "/pricemapping" ? "is-active" : ""}>
                                Manage Price
                            </Link>
                        </NavItem>
                    ) : (
                    ...
                    {this.state.user.user_type == "SP" ? (
                        <NavItem className="px-3">
                            <Link to="/spoquote" className={pathName == "/spoquote" ? "is-active" : ""}>
                                SPO Quote
                            </Link>
                        </NavItem>
                    ) : (
                    ...
                    {this.state.user.user_type == "SP" ? (
                        <NavItem className="px-3">
                            <Link to="/productselector" className={pathName == "/productselector" ? "is-active" : ""}>
                                Product Selector
                            </Link>
                        </NavItem>
                    ) : (
                    ...
                    {this.state.user.user_type == "WU" ? (
                        <NavItem className="px-3">
                            <Link
                                to="/warrantyorderform"
                                className={pathName == "/warrantyorderform" ? "is-active" : ""}
                            >
                                Warranty Order Form
                            </Link>
                        </NavItem>
                    ...
                    <AppHeaderDropdown direction="down">
                        <DropdownToggle className="bg_white my_account">
                            <span className="d-md-down-none">
                                <NavLink>
                                    <img
                                        src={"../../assets/dealerlogo/dealerlogo_" + this.state.user.id + ".png"}
                                        onError={(e) => {
                                    ...
                                    />
                                    Welcome {this.state.user.user_type == "SA" ? "Super Admin" : "Dealer"}:{" "}
                                    {this.state.user.user_name}
                                    <i className="fa fa-angle-down down_icon" />
                                </NavLink>
                            </span>
                        </DropdownToggle>
                        <DropdownMenu right style={{ right: "auto" }}>
                            ...
                            <DropdownItem onClick={this.toggle_cp}>
                ...
                <Modal isOpen={this.state.modal} toggle={this.toggle}>
                    ...
                    <ModalFooter>
                        ...
                        <Link to="/logout_post" className="btn btn-danger" onClick={this.logout}>
                            Logout
                        </Link>
                    </ModalFooter>
                </Modal>
                ...
                <Modal isOpen={this.state.modal_cp} toggle={this.toggle_cp}>
                    <ModalHeader toggle={this.toggle_cp}>
                        Change Password <i className="fa fa-lock" />
                    </ModalHeader>
                    <ModalBody>
                ...
                <Modal isOpen={this.state.modal_cp_timeout} toggle={this.toggle}>
                    ...
                    <ModalBody>
                        <i className="fa fa-question-circle" /> Your session will expire In 10 seconds.. Are you sure
                        want to logout or Continue?
                    </ModalBody>
                    <ModalFooter>
                        <Button className="btn btn-success" onClick={this.expire_data_send}>
                            Continue
                        </Button>
                    </ModalFooter>
                </Modal>
