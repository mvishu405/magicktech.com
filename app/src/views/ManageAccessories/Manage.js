    ...
    return (
      ...
      <Row className="align-items-center">
        <Col xs="12" lg="12">
          <Card>
            <CardHeader>
              <i className="fa fa-align-justify"></i> Accessories List
              <Link to="/accessories/add">
              <Button outline color="primary" className="float-right">Add Accessories</Button>
              </Link>
            </CardHeader>
            <CardBody>
			   ...
			   <ReactTable 
				  columns={[
						...
						},
						{
						  ...
						  accessor: d => (
							<span>
							<Link to={"/accessories/edit/?type=edit&id="+d.id} className="btn btn-ghost-info mr10 action_btn"><i className="fa fa-edit"  title="Edit"></i></Link>

							<div onClick={this.beforeDelete.bind(this, d.id)} className="btn btn-ghost-danger action_btn"><Link to={"/accessories/"+d.id} title="Delete" className="color_red"><i className="fa fa-trash"></i></Link></div>
							</span>
						  )				  
						}				
