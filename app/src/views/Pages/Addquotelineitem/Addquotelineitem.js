...
class Addquotelineitem extends Component {
    ...
    async componentWillMount() {
        ...
        try {
            ...
            this.setState({ get_all_categories: allCategories });
        } catch (error) {
        ...
        /** Fetch Mproducts */
        try {
            const mproducts = await this.productService.getAllProducts();
            this.setState({ get_all_mproducts: mproducts });
        } catch (error) {
    ...
    /** This method is called when we try to submit the data to server---->> */
        ...
        if (this.state.line_item_options.length > 0 && validate_quantity.length < 1) {
            if (validate.length === 0) {
                ...
                let post_json = {
                    ...
                    deleted: this.state.removedlines,
                    ...
                    cabinet_discount: this.state.cabinet_discount,
                    accessories_discount: this.state.accessories_discount,
                    square_feet: this.state.square_feet,
                    show_cabinetprice: this.state.show_cabinetprice,
                    quoteforname: this.state.quoteforname,
                    other_services: this.state.service_rows,
                };
    ...
    handleRowClone(pid, products) {
        ...
        var product = {
            ...
            mproduct_id: products.mproduct_id,
        };
    ...
    handleProductTable(evt) {
        ...
        console.log(this.state.line_item_options);
    }
    ...
    quote_alert_fun(text, c_name, c_id) {
        return (
            <Alert color="success" className="alertmargin-70">
                Quote Succesfully {text} for {c_name} [{c_id}]
            </Alert>
        );
    }
    ...
    render() {
        ...
        let quote_alert_text = this.quote_alert_fun(
            "Created!",
            get_customer_details["name"],
            get_customer_details["cid"]
        );

        if (this.state.status == 2) {
            quote_alert_text = this.quote_alert_fun(
                "Saved!",
                get_customer_details["name"],
                get_customer_details["cid"]
            );
        ...
        return (
            <div>
                <div className="quote_head_row">
                    <span
                        className="btn btn-light mr10 cursor_none"
                        style={
                            this.qid != 0 && this.saved != "true" ? { display: "inline-block" } : { display: "none" }
                        }
                    >
                        Adding revision for Quote id: {quote_number}
                    </span>
                    ...
                    <button
                        ...
                        onClick={this.add_quote_line_item.bind(this, 2)}
                        style={
                            this.state.showpdflink ? { display: "none" } : { background: "rgba(255, 255, 255, 0.8)" }
                        }
                    >
                        Save
                    </button>
                    ...
                    <input
                        ...
                        onClick={this.toggle_cq}
                        style={this.state.showpdflink ? { display: "none" } : {}}
                    />
                    ...
                    <Modal isOpen={this.state.modal_cq} toggle={this.toggle_cq}>
                            ...
                            <Form method="post" encType="multipart/form-data" className="form-horizontal">
                                <FormGroup row>
                                    <Col md="6">
                                        <Label htmlFor="text-input">
                                            Project Name <sup className="color_red">*</sup>
                                        </Label>
                                    </Col>
                                    <Col md="6">
                                        <input
                                            type="text"
                                            id="quoteforname"
                                            defaultValue={get_customer_details["name"]}
                                            className="form-control"
                                            onChange={this.ChangeDiscount.bind(this, "quoteforname")}
                                        />
                                    </Col>
                                </FormGroup>
                                <FormGroup row>
                                    <Col md="6">
                                        <Label htmlFor="text-input">
                                            Select Designer <sup className="color_red">*</sup>
                                        </Label>
                                    </Col>
                                    <Col md="6">
                                        <Select
                                            ...
                                            name="designer_id"
                                            id="designer_id"
                                            onChange={this.ChangeDiscount.bind(this, "designer_id")}
                                ...
                                <FormGroup row>
                                    ...
                                    <Col md="6">
                                        <Select
                                            isClearable
                                            name="cabinet_discount"
                                            id="cabinet_discount"
                                            defaultValue={cabinet_discount_opt[0]}
                                            onChange={this.ChangeDiscount.bind(this, "cabinet_discount")}
                                ...
                                <FormGroup row>
                                    ...
                                    <Col md="6">
                                        <Select
                                            ...
                                            id="accessories_discount"
                                            defaultValue={accessories_discount_opt[0]}
                                            onChange={this.ChangeDiscount.bind(this, "accessories_discount")}
                                ...
                                <FormGroup row>
                                    <Col md="6">
                                        <Label htmlFor="text-input">
                                            Square Feet <sup className="color_red">*</sup>
                                        </Label>
                                    </Col>
                                    <Col md="6">
                                        <Input
                                            ...
                                            name="square_feet"
                                            placeholder="Ex: 300"
                                            onChange={this.ChangeDiscount.bind(this, "square_feet")}
                                        />
                                    </Col>
                                </FormGroup>
                                <FormGroup row>
                                    ...
                                    <Col md="6">
                                        <Input
                                            type="checkbox"
                                            id="show_cabinetprice"
                                            name="show_cabinetprice"
                                            onChange={this.ChangeDiscount.bind(this, "show_cabinetprice")}
                                        />
                                    </Col>
                                </FormGroup>
                            </Form>
                        ...
                        <ModalFooter>
                            <span className="color_red" style={!isEnabled ? {} : { display: "none" }}>
                                <sup>*</sup> Field required!
                            </span>
                            <Button
                                disabled={!isEnabled}
                                onClick={this.add_quote_line_item.bind(this, 1)}
                                style={{ padding: "0" }}
                            >
                                <span className="btn btn-primary">Create Quote</span>
                            </Button>
                        </ModalFooter>
                    </Modal>
                </div>
                ...
                <div style={this.state.showpdflink ? { display: "none" } : {}}>
                    <ProductTable
                        ...
                        /**-- */
                        categories={this.state.get_all_categories}
                        mproducts={this.state.get_all_mproducts}
                    />
                                ...
                                <CardBody>
                                    <div className="container">
                                        <div className="row clearfix">
                                            <Button
                                                className="btn btn-success btn-md ml-2 service_add_btn"
                                                onClick={this.ServicehandleAddRow}
                                            >
                                                Add Services
                                            </Button>
                                                            ...
                                                            <tr id="addr0" key={idx}>
                                                                ...
                                                                <td>
                                                                    <Button
                                                                        ...
                                                                        onClick={this.ServicehandleRemoveSpecificRow(
                                                                            idx
                                                                        )}
                                                                    >
                                                                    ...
                                                                    <Button
                                                                        className="btn btn-ghost-success btn-md ml-2"
                                                                        onClick={this.ServicehandleAddRow}
                                                                    >
        ...
        return (
            <tr className="text-center">
                ...
                <EditableCellSubCategory
                    onProductTableUpdate={this.props.onProductTableUpdate}
                    categories={this.props.categories}
                    parent_category_id={this.props.product.parent_category_id}
                    cellData={{
                ...
                <EditableCellProduct
                    onProductTableUpdate={this.props.onProductTableUpdate}
                    mproducts={this.props.mproducts}
                    sub_category_id={this.props.product.sub_category_id}
                    cellData={{
                        type: "mproduct_id",
                ...
                <EditableCellCode
                    ...
                    mproduct_id={this.props.product.mproduct_id}
                ...
                <td className="clone-cell" width="20%">
                    ...
                    />
                    <div
                        onClick={this.onCloneEvent.bind(this)}
                        value="Clone"
                        className="btn btn-ghost-info colorwhite del-btn inline_block"
                    >
                    ...
                    <div
                        ...
                        value="Delete"
                        className="btn btn-ghost-danger colorwhite del-btn inline_block"
                    >
                        <i className="fs16 fa fa-trash-o" aria-hidden="true" />
                    </div>
                </td>
            </tr>
        );
...
/** Updated Code For Category Sub Category and Products */
...
class EditableCellCategory extends React.Component {
    ...
    handleChange(event) {
        this.props.onProductTableUpdate({
            target: { id: this.props.cellData.id, name: this.props.cellData.type, value: event.target.value },
        });
    }

    render() {
        const categories = this.props.categories.filter((c) => c.parent_id === null);
...
class EditableCellSubCategory extends React.Component {
    render() {
        const selectedSubCategory = this.props.categories.filter((c) => c.parent_id === this.props.parent_category_id);
...
class EditableCellProduct extends React.Component {
    render() {
        const mproducts = this.props.mproducts.filter((product) => product.category_id === this.props.sub_category_id);
...
class EditableCellCode extends React.Component {
    ...
    render() {
        let filter_code = this.props.codes.filter((type) => {
            ...
            // }
            return type.product_id === this.props.mproduct_id;
        });
