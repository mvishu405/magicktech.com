      ...
      <Card>
        ...
        <Form method="post" encType="multipart/form-data" className="form-horizontal" onSubmit={this.handleSubmit}>
          <FormGroup row>
            ...
            <Col xs="12" md="9">
              <Input type="text" id="code" name="code" placeholder="" onChange={this.handleChange} defaultValue={this.state.code}/>
          ...
          <FormGroup row>
            ...
            <Col xs="12" md="9">
              <Input type="text" id="description" name="description" placeholder="" onChange={this.handleChange} defaultValue={this.state.description}/>
          ...
          <FormGroup row>
            ...
            <Col xs="12" md="9">
              <Input type="number"  id="width" name="width" placeholder="" onChange={this.handleChange} defaultValue={this.state.width} />
          ...
          <FormGroup row>
            ...
            <Col xs="12" md="9">
              <Input type="number" id="depth" name="depth" placeholder="" onChange={this.handleChange} defaultValue={this.state.depth}/>
          ...
          <FormGroup row>
            ...
            <Col xs="12" md="9">
              <Input type="number" id="height" name="height" placeholder="" onChange={this.handleChange} defaultValue={this.state.height}/>
          ...
          <FormGroup row>
            ...
            <Col xs="12" md="9">
			  	<Select
				isClearable
				name='cabinet_type' id='cabinet_type' value={default_type_opt[this.state.cabinet_type]}  onChange={this.handleChangeDropdown.bind(this, 'cabinet_type')}
